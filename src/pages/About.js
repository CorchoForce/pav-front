        ...
        <div>
            ...
            <div className={styles.aboutContainer}>
                ...
                <div className={styles.gridContainer}>
                    <div className={styles.gridElement1}> </div>
                    <div className={styles.gridElement2}> </div>
                    <div className={styles.gridElement3}> </div>
                    <div className={styles.gridElement4}> </div>
                    <div className={styles.gridElement5}> </div>
                </div>
            </div>
            </BrowserView>
            <MobileView>
