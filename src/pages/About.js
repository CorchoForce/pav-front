        ...
        <div>
            ...
            <MobileView>
                ...
                <div className={styles.mobileFirstContainer}>
                        <h1 className={styles.titleLeft}>Sobre o<br></br>Pega a visão</h1>
                        <div className={styles.mobileSmallGridCountainer}>Uma plataforma que simplifica a busca de atividades extracurriculares dentro e fora da universidade.<br></br>De alunos para alunos.</div>
                    </div>
                    <div className={styles.mobileSecondContainer}>
                        <h1 className={styles.titleLeft}>Por que<br></br>surgimos?</h1>
                        <div className={styles.mobileBiggerGridCountainer}>Quantas vezes, na UFRJ, o aluno teve problemas para encontrar a sua tão sonhada vaga de Iniciação científica, Extensão, Equipes de competição ou até mesmo estágio, no qual este ficou a mercê de emails dos coordenadores ou até mesmo dos anunciantes da vaga?
                                    <br></br>
                    ...
                    <div className={styles.mobileThirdContainer}>
                        <h1 className={styles.titleLeft}>Como usar?</h1>
                        <div className={styles.mobileBiggerGridCountainer}>Como aluno, navegue pela página inicial procurando pela vaga que mais lhe agrada, podendo usar nosso mecanismo de busca para facilitar a escolha.
                                    <br></br>
                                <br></br>
                    ...
                    <div className={styles.mobileFourthContainer}>
                        <h1 className={styles.titleLeft}>Nossa missão</h1>
                        <div className={styles.mobileSmallGridCountainer}>Nossa missão é melhorar o contato do aluno com o ofertante da vaga, de modo que não haja atrito entre outras pessoas.</div>
                    </div>
                </div>
